...
function composeNameObjFinder(personObject, opts) {
	...
	if (o === void 0) {
		logger.error('Error finding name components at composeNameObjFinder at "' + JSON.stringify(personObject) + '" with opts ' + JSON.stringify(opts))
...
function isObject(sth) {
	return sth !== null && typeof sth === 'object' && sth.constructor.toString().indexOf("Array") === -1
}